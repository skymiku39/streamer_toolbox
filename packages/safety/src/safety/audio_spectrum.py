...
def lacks_clear_speech(
    ...
    *,
    ...
    if flatness > max_spectral_flatness:
        return True
    ratio = speech_band_energy_ratio(audio, sample_rate)
    return ratio < min_speech_band_ratio
