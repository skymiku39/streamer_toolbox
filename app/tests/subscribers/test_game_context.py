...
def test_build_game_reference_skips_non_game_questions() -> None:
    provider = StubGameProvider(GameReviewInfo(name="Bad North"))
    assert (
        build_game_reference("LNG 是什麼", game_name="Bad North", provider=provider)
        == ""
    )
