...
class MemoryViewService:
    ...
    def resolve_active_session_id(self) -> str | None:
    ...
    def sessions_payload(self, *, revision: int = 0) -> dict:
        active_session_id = self.resolve_active_session_id()
        return {
            "revision": revision,
    ...
    def summaries_payload(self, session_id: str, *, revision: int = 0) -> dict:
        return {
            "revision": revision,
